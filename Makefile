# This Makefile is for the Reports extension to perl.
#
...
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[Reports]
#     EXE_FILES => [q[script/reports_cgi.pl], q[script/reports_create.pl], q[script/reports_fastcgi.pl], q[script/reports_server.pl], q[script/reports_test.pl]]
#     LICENSE => q[perl]
#     NAME => q[Reports]
#     NO_META => q[1]
...
AR = c:\Rtools\GCC-46~1.3\bin\ar.exe
CC = c:\Rtools\GCC-46~1.3\bin\gcc.exe
CCCDLFLAGS =  
CCDLFLAGS =  
DLEXT = dll
DLSRC = dl_win32.xs
EXE_EXT = .exe
FULL_AR = 
LD = c:\Rtools\GCC-46~1.3\bin\g++.exe
...
O_FILES  = 
H_FILES  = 
MAN1PODS = script/reports_cgi.pl \
	script/reports_create.pl \
	script/reports_fastcgi.pl \
	script/reports_server.pl \
	script/reports_test.pl
MAN3PODS = lib/Reports.pm \
	lib/Reports/Controller/Root.pm
...
TO_INST_PM = lib/Reports.pm \
	lib/Reports/Controller/Root.pm

PM_TO_BLIB = lib/Reports.pm \
	blib\lib\Reports.pm \
	lib/Reports/Controller/Root.pm \
	blib\lib\Reports\Controller\Root.pm
...
Reports.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Reports\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=1 --perm_rw=$(PERM_RW) \
	  script/reports_server.pl $(INST_MAN1DIR)\reports_server.pl.$(MAN1EXT) \
	  script/reports_cgi.pl $(INST_MAN1DIR)\reports_cgi.pl.$(MAN1EXT) \
	  script/reports_fastcgi.pl $(INST_MAN1DIR)\reports_fastcgi.pl.$(MAN1EXT) \
	  script/reports_test.pl $(INST_MAN1DIR)\reports_test.pl.$(MAN1EXT) \
	  script/reports_create.pl $(INST_MAN1DIR)\reports_create.pl.$(MAN1EXT) 
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Reports.pm $(INST_MAN3DIR)\Reports.$(MAN3EXT) \
	  lib/Reports/Controller/Root.pm $(INST_MAN3DIR)\Reports.Controller.Root.$(MAN3EXT) 
...
EXE_FILES = script/reports_cgi.pl script/reports_create.pl script/reports_fastcgi.pl script/reports_server.pl script/reports_test.pl

pure_all :: $(INST_SCRIPT)\reports_server.pl $(INST_SCRIPT)\reports_cgi.pl $(INST_SCRIPT)\reports_fastcgi.pl $(INST_SCRIPT)\reports_test.pl $(INST_SCRIPT)\reports_create.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)\reports_server.pl $(INST_SCRIPT)\reports_cgi.pl \
	  $(INST_SCRIPT)\reports_fastcgi.pl $(INST_SCRIPT)\reports_test.pl \
	  $(INST_SCRIPT)\reports_create.pl 

$(INST_SCRIPT)\reports_server.pl : script/reports_server.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\reports_server.pl
	$(CP) script/reports_server.pl $(INST_SCRIPT)\reports_server.pl
	$(FIXIN) $(INST_SCRIPT)\reports_server.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\reports_server.pl

$(INST_SCRIPT)\reports_cgi.pl : script/reports_cgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\reports_cgi.pl
	$(CP) script/reports_cgi.pl $(INST_SCRIPT)\reports_cgi.pl
	$(FIXIN) $(INST_SCRIPT)\reports_cgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\reports_cgi.pl

$(INST_SCRIPT)\reports_fastcgi.pl : script/reports_fastcgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\reports_fastcgi.pl
	$(CP) script/reports_fastcgi.pl $(INST_SCRIPT)\reports_fastcgi.pl
	$(FIXIN) $(INST_SCRIPT)\reports_fastcgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\reports_fastcgi.pl

$(INST_SCRIPT)\reports_test.pl : script/reports_test.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\reports_test.pl
	$(CP) script/reports_test.pl $(INST_SCRIPT)\reports_test.pl
	$(FIXIN) $(INST_SCRIPT)\reports_test.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\reports_test.pl

$(INST_SCRIPT)\reports_create.pl : script/reports_create.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\reports_create.pl
	$(CP) script/reports_create.pl $(INST_SCRIPT)\reports_create.pl
	$(FIXIN) $(INST_SCRIPT)\reports_create.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\reports_create.pl
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/Reports.pm blib\lib\Reports.pm \
	  lib/Reports/Controller/Root.pm blib\lib\Reports\Controller\Root.pm 
